    ...
    :State(stack, context)
{
    ...
    lobby_join_button->setPosition(400, 500);
    ...
    host_play_button->setPosition(400, 600);
    ...
    join_play_button->setPosition(400, 700);
    ...
    settings_button->setPosition(400, 800);
    ...
    exit_button->setPosition(400, 900);
