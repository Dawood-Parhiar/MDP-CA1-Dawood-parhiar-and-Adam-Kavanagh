...
NewMultiplayerGameState::NewMultiplayerGameState(StateStack& stack, Context context, bool is_host)
	:State(stack, context)
...
void NewMultiplayerGameState::HandleSpawnPickup(sf::Packet& packet)
{
	sf::Int32 type;
